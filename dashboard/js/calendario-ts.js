...
class CalendarioTS {
    ...
    obterDadosDia(turma, dia, mes, ano) {
        ...
        const hisDoDia = allHIs.map(hi => ({
            ...
            operadores: parseInt(hi['Operadores'] || hi.operadores || 0) || efetivo.operadores || 5,
                                            ...
                                            ${servicosFormatados.map((s, i) => `
                                                <tr id="srv-row-${i}">
                                                    ...
                                                    <td class="edit-ctrl text-center" style="display:none;">
                                                        <input type="checkbox" class="form-check-input srv-check me-2" data-idx="${i}"
                                                               onchange="editorRDO._atualizarBotaoExcluirSrv()" title="Selecionar para exclusão em lote">
                                                        <div class="edit-ctrl-btns-srv d-inline-block">${editorRDO._htmlSrvBtns(i)}</div>
                                                    </td>
                                                </tr>
                                            `).join('')}
                                        </tbody>
